...
const Layout = ({ children }) => {
  ...
  return (
    <div className="min-h-screen transition-colors dark:text-white bg-gray-200 dark:bg-gray-900 flex flex-col">
      <Header siteTitle={data.site.siteMetadata?.title || `Title`} />
      <main className="flex-grow">{children}</main>
      <footer className="bg-white transition-colors dark:bg-gray-800 h-28 py-4">
